...
<asp:Label ID="lblMsg" runat="server" ></asp:Label>
    ...
    <div class="row mr-lg-5 mb-lg-5 mb-3">
        <div class="col-md-6 pt-3">
            ...
            <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. NCEA, MBA, Bursery" required>
    ...
    <div class="row mr-lg-5 mb-lg-5 mb-3">
        <div class="col-md-6 pt-3">
            ...
            <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex: 70K - 90K per year"  required>
    ...
    <div class="row mr-lg-5 mb-lg-5 mb-3">
        <div class="col-md-6 pt-3">
            ...
            <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder="Company/Organization Name"  required>
