    ...
    public partial class NewJob : System.Web.UI.Page
    {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                if (sdr.HasRows)
                {
                    while (sdr.Read())
                    {
                        ...
                        txtEmail.Text = sdr["Address"].ToString();
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    query = @"Insert into Jobs values(@Title,@NoOfPost,@Description,@Qualification,@Experience,@Specialization,@LastDateToApply,@Salary,@JobType,@CompanyName,@CompanyImage,@Website,@Email,@Address,@Country,@State,@CreatedDate)";
                    type = "saved";
