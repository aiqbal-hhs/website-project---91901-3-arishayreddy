                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control" placeholder="Enter Unique Username" required Width="100%"></asp:TextBox>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" placeholder="Enter Password" required TextMode="Password" Width="570px"></asp:TextBox>
                                </div>
                            </div>
