                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Name must be in characters" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="Small" ValidationExpression="^[a-zA-Z\s]+$" ControlToValidate="txtFullName"></asp:RegularExpressionValidator>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtGraduation" runat="server" CssClass="form-control" placeholder="PHD with Grade"></asp:TextBox>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <label>PHD with Percenatge/Grade</label>

                                    <asp:TextBox ID="txtPhd" runat="server" CssClass="form-control" placeholder="Ex: Btech with 9.2 pointer"></asp:TextBox>
