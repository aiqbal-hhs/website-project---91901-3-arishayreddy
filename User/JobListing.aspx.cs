    ...
    public partial class JobListing : System.Web.UI.Page
    {
        ...
        private void showJobList()
        {
            if (dt == null)
            {
                ...
                string query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,State,CreatedDate from Jobs";
        ...
        protected void ddlCountry_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con = new SqlConnection(str);
                string query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,State,CreatedDate from Jobs where Country = '" + ddlCountry.SelectedValue + "'";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        // Setting default image if there is no longer any job.
        ...
        protected void CheckBoxList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con = new SqlConnection(str);
                string query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,State,CreatedDate from Jobs where JobType IN (" + jobType + ")";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        string selectedCheckBox()
        {
            ...
            for (int i = 0; i < CheckBoxList1.Items.Count; i++)
            {
                ...
                {
                    jobType += "'" + CheckBoxList1.Items[i].Text + "',"; //FullName,Remote,
                }
            }
        ...
        protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (RadioButtonList1.SelectedValue != "0")
            {
                ...
                con = new SqlConnection(str);
                string query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,State,CreatedDate from Jobs where Convert(DATE,CreatedDate)" + postedDate + " ";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void lbFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isCondition)
                {
                    ...
                    {
                        subquery += a + " and "; // Country = 'New Zealand' and JobType IN ('Full Time, Part Time')
                    }
                    subquery = subquery.Remove(subquery.LastIndexOf("and"), 3);
                    query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,State,CreatedDate from Jobs where " + subquery + " ";
